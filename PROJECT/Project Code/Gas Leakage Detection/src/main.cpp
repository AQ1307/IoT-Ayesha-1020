...
void setup() {
  ...
  // OLED Setup
  Wire.begin(21, 22);
  display.begin(SSD1306_SWITCHCAPVCC, OLED_ADDR);   // OLED_ADDR = 0*3C
  ...
  Blynk.begin(BLYNK_AUTH_TOKEN, ssid, pass);   //BLYNK_AUTH_TOKEN connects your hardware to your Blynk project.
}
